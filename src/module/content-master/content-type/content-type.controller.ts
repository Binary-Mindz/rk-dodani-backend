...
export class ContentTypeController {
  ...
  @ApiOperation({
    description:
      'Code are : ARTICLE | WHITE_PAPER | CASE_STUDY | REPORT | PODCAST | VIDEO | RESEARCH_NOTE | MEDIA_POST',
    summary: 'Create new Content Type -- Only for admin',
  })
  ...
  @ApiOperation({
    description:
      'Code are : ARTICLE | WHITE_PAPER | CASE_STUDY | REPORT | PODCAST | VIDEO | RESEARCH_NOTE | MEDIA_POST',
    summary: 'Update Content Type -- Only for admin',
  })
