...
export class CreateProductSubmissionDto {
  @ApiProperty({ description: 'Full name of the requester', example: 'Yonas Yohannes' })
  @IsString()
  @IsNotEmpty()
  fullName!: string;

  @ApiProperty({ description: 'Corporate email address', example: 'yohan@athenion.com' })
  @IsEmail()
  corporateEmail!: string;

  @ApiPropertyOptional({ description: 'Company / institution name', example: 'Athenion Systems' })
  @IsString()
  @IsOptional()
  company?: string;
