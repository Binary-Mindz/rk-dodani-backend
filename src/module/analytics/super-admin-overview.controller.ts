...
export class SuperAdminOverviewController {
  ...
  @ApiOperation({
    summary:
      'Get Super Admin overview dashboard key metrics (MRR, Active Paid Users, Conversion Rate, Open Tickets) and growth stats',
  })
  ...
  @ApiOperation({
    summary:
      'Get top 5 published content items by engagement (downloads or views count)',
  })
  ...
  @ApiOperation({
    summary:
      'Get cohort subscription retention percentages over the last 6 months',
  })
