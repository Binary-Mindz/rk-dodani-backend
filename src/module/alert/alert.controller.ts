...
export class AlertController {
  ...
  @ApiOperation({
    description:
      'alertType : INFO | SUCCESS | WARNING | ERROR | SYSTEM | MAINTENANCE  || alertMethod : PUSH | EMAIL | SMS',
    summary: 'Create New Alert -- Only for admin',
  })
  ...
  @ApiOperation({
    summary: 'Get all alerts with pagination (Last created first) - Public',
  })
  async get_all_alerts(
    ...
    const result = await this.alertService.get_all_alerts_from_db(
      pageNumber,
      limitNumber,
    );
