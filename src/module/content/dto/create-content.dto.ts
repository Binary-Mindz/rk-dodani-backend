...
export class CreateContentDto {
  ...
  @ApiPropertyOptional({
    ...
    example: 'How modern leaders adopt AI',
  })
  @IsOptional()
  @IsString()
  @MaxLength(255)
  ...
  @ApiPropertyOptional({
    ...
    example: 'Concise overview of AI adoption trends.',
  })
  @IsOptional()
  @IsString()
  @MaxLength(500)
  ...
  @ApiPropertyOptional({
    ...
    example: 'This whitepaper explores how AI transforms leadership strategy.',
  })
  @IsOptional()
  @IsString()
  @MaxLength(1000)
  ...
  @ApiPropertyOptional({
    ...
    example: 'Full article plain text goes here...',
  })
  @IsOptional()
  @IsString()
  ...
  @ApiPropertyOptional({
    description: 'External embed code for iframe/video',
  ...
  @ApiPropertyOptional({
    description: 'Primary asset attachment URL (Merged Field)',
    example: 'https://cdn.example.com/files/ai-whitepaper.pdf',
  })
  @IsOptional()
  @IsUrl()
  fileUrl?: string;
  ...
  @ApiPropertyOptional({
    description: 'Whether asset downloading is allowed',
    default: true,
    example: true,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Whether downloading requires terms acceptance',
    default: false,
    example: false,
  })
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Terms text for acceptance',
    example: 'By downloading, you agree to our terms.',
  })
  @IsOptional()
  @IsString()
  termsText?: string;
  ...
  @ApiPropertyOptional({
    type: [String],
    example: ['c5a0f0e2-8d46-4a56-a527-77d9b2a15c11'],
  })
  @IsOptional()
  @IsArray()
  @IsUUID('4', { each: true })
