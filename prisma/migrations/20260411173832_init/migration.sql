...
CREATE TABLE "StoredFile" (
    ...
    "checksumSha256" TEXT,
    "etag" TEXT,
    "fileKind" "StoredFileKind" NOT NULL,
    "accessLevel" "StoredFileAccessLevel" NOT NULL DEFAULT 'PRIVATE',
    "isPublic" BOOLEAN NOT NULL DEFAULT false,
    "publicUrl" TEXT,
    "cdnUrl" TEXT,
    "signedUrlExpiresInSeconds" INTEGER,
    "imageWidth" INTEGER,
    "imageHeight" INTEGER,
...
-- CreateIndex
CREATE INDEX "ContentAsset_storedFileId_idx" ON "ContentAsset"("storedFileId");
...
-- CreateIndex
CREATE INDEX "StoredFile_fileKind_idx" ON "StoredFile"("fileKind");

-- CreateIndex
CREATE INDEX "StoredFile_accessLevel_idx" ON "StoredFile"("accessLevel");
...
-- AddForeignKey
ALTER TABLE "ContentAsset" ADD CONSTRAINT "ContentAsset_storedFileId_fkey" FOREIGN KEY ("storedFileId") REFERENCES "StoredFile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "ContentItem" ADD CONSTRAINT "ContentItem_coverImageFileId_fkey" FOREIGN KEY ("coverImageFileId") REFERENCES "StoredFile"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ContentItem" ADD CONSTRAINT "ContentItem_thumbnailFileId_fkey" FOREIGN KEY ("thumbnailFileId") REFERENCES "StoredFile"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ContentItem" ADD CONSTRAINT "ContentItem_ogImageFileId_fkey" FOREIGN KEY ("ogImageFileId") REFERENCES "StoredFile"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Page" ADD CONSTRAINT "Page_heroImageFileId_fkey" FOREIGN KEY ("heroImageFileId") REFERENCES "StoredFile"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Page" ADD CONSTRAINT "Page_ogImageFileId_fkey" FOREIGN KEY ("ogImageFileId") REFERENCES "StoredFile"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Service" ADD CONSTRAINT "Service_iconFileId_fkey" FOREIGN KEY ("iconFileId") REFERENCES "StoredFile"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Service" ADD CONSTRAINT "Service_coverImageFileId_fkey" FOREIGN KEY ("coverImageFileId") REFERENCES "StoredFile"("id") ON DELETE SET NULL ON UPDATE CASCADE;
