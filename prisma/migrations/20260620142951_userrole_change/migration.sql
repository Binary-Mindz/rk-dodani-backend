/*
  ...
  - The values [SOLO_PROF,SMB] on the enum `UserRoleCode` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "UserRoleCode_new" AS ENUM ('SUPER_ADMIN', 'STUDENT', 'ENTERPRISE');
